...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<?php Estructura::getHeadIndex(); ?>
	<body>
		<div class="box-wrap">
			<?php Estructura::getMenuIndex(); ?>
			<!-- END: header -->
				...
				<div class="container">
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2 text-center heading-section">
							<h3>Bienvenido a La Vie En rouse</h3>
							<p>Arreglos florales personalizados para toda ocasión con bases de madera artesanales.</p>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-5">
							<div class="fh5co-cover">
								...
								<div class="fh5co-cover-hero animate-box">
									<div class="fh5co-cover-thumb" style="background-image: url(assets/images/work-4.jpg);"></div>
									<div class="desc-thumb">
										<p>Far far away, behind the word mountains, far from the</p>
			...
			<div id="fh5co-intro-section">
				<div class="fh5co-intro-cover text-center animate-box" data-animate-effect="fadeIn" data-stellar-background-ratio="0.5" style="background-image: url(assets/images/intro.jpg);">
					<a href="#" class="btn">Servirle es nuestra prioridad</a>
				</div>
			</div>
			...
			<div id="fh5co-product-section">
				<div class="container">
					...
					<div class="owl-carousel owl-carousel2">
						<div class="item animate-box"><a href="images/product-1.jpg" class="image-popup"><img src="assets/images/product-1.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-2.jpg" class="image-popup"><img src="assets/images/product-2.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-3.jpg" class="image-popup"><img src="assets/images/product-3.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-4.jpg" class="image-popup"><img src="assets/images/product-4.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-1.jpg" class="image-popup"><img src="assets/images/product-1.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-2.jpg" class="image-popup"><img src="assets/images/product-2.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-3.jpg" class="image-popup"><img src="assets/images/product-3.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-4.jpg" class="image-popup"><img src="assets/images/product-4.jpg" alt="image"></a></div>
						...
						<div class="item animate-box"><a href="images/product-2.jpg" class="image-popup"><img src="assets/images/product-2.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-3.jpg" class="image-popup"><img src="assets/images/product-3.jpg" alt="image"></a></div>
						<div class="item animate-box"><a href="images/product-4.jpg" class="image-popup"><img src="assets/images/product-2.jpg" alt="image"></a></div>
					</div>
				</div>
			</div>
